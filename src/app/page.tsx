  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-x-clip">
      ...
      <main className="flex-1 relative">
        ...
        {/* 2. SERVICES SECTION */}
        <div className="sticky top-[85px] z-10 h-[calc(100vh-85px)] overflow-y-auto bg-white rounded-t-[2.5rem] shadow-[0_-20px_50px_rgba(0,0,0,0.1)] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <section className="py-20 min-h-[calc(100vh-85px)] flex flex-col justify-center relative overflow-hidden">
                    ...
                    <div className="h-full rounded-3xl p-8 bg-white/70 backdrop-blur-xl border border-white shadow-xl shadow-[#00C896]/5 hover:shadow-2xl hover:shadow-[#00C896]/15 hover:-translate-y-1 transition-all duration-500 relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="mt-7 flex flex-wrap items-center gap-3">
                          <Link href="/plans/website" className="inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-[#0F172A] text-white font-black hover:bg-[#10B981] hover:-translate-y-0.5 active:scale-[0.99] transition-all">
                            View Packages
                          </Link>
                          <Link href="/contact" className="inline-flex items-center justify-center px-6 py-3 rounded-2xl border border-[#0F172A]/10 bg-white text-[#0F172A] font-black hover:border-[#10B981] hover:text-[#10B981] hover:-translate-y-0.5 active:scale-[0.99] transition-all">
                            Talk to Us
                          </Link>
                        </div>
                  ...
                  <TiltCard className="group h-full">
                    <div className="h-full rounded-3xl p-8 bg-[#0F172A] text-white border border-white/10 shadow-2xl shadow-[#0F172A]/10 hover:-translate-y-1 transition-all duration-500 relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="mt-7 flex flex-wrap items-center gap-3">
                          <Link href="/plans/app" className="inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-gradient-to-r from-[#00C896] to-[#00E6A8] text-[#0F172A] font-black hover:shadow-lg hover:shadow-[#00C896]/30 hover:-translate-y-0.5 active:scale-[0.99] transition-all">
                            View Packages
                          </Link>
                          <Link href="/contact" className="inline-flex items-center justify-center px-6 py-3 rounded-2xl border border-white/20 text-white font-black hover:border-white/50 hover:bg-white/10 hover:-translate-y-0.5 active:scale-[0.99] transition-all">
                            Talk to Us
                          </Link>
                        </div>
        ...
        {/* 3. PROCESS SECTION */}
        <div className="sticky top-[85px] z-20 h-[calc(100vh-85px)] overflow-y-auto bg-[#F8FAFC] shadow-[0_-20px_50px_rgba(0,0,0,0.05)] border-t border-slate-200 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <section className="py-20 min-h-[calc(100vh-85px)] flex flex-col justify-center relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <Reveal className="text-center mb-14">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/70 border border-[#D1FAE5] text-[#0F766E] font-bold tracking-wide">
                  Process
        ...
        {/* 4. WHY US SECTION */}
        <div className="sticky top-[85px] z-30 h-[calc(100vh-85px)] overflow-y-auto bg-white shadow-[0_-20px_50px_rgba(0,0,0,0.05)] border-t border-slate-100 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <section className="py-20 min-h-[calc(100vh-85px)] flex flex-col justify-center relative overflow-hidden">
            <div className="absolute inset-0 -z-10">
                  ...
                  <div className="h-full rounded-3xl bg-white/70 backdrop-blur-xl border border-white shadow-2xl shadow-[#00C896]/10 p-8 sm:p-10 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="mt-8 flex flex-col sm:flex-row gap-3">
                        <Link href="/contact" className="inline-flex items-center justify-center px-7 py-3.5 rounded-2xl bg-[#0F172A] text-white font-black hover:bg-[#10B981] hover:-translate-y-0.5 active:scale-[0.99] transition-all">
                          Contact Us
                        </Link>
                        <a href="mailto:shridevfreelanceofficial@gmail.com" className="inline-flex items-center justify-center px-7 py-3.5 rounded-2xl border border-[#0F172A]/10 bg-white font-black text-[#0F172A] hover:border-[#10B981] hover:text-[#10B981] hover:-translate-y-0.5 active:scale-[0.99] transition-all">
                          Email Directly
                        </a>
                      </div>
                    </div>
        ...
        {/* 5. FOUNDER SECTION */}
        <div className="sticky top-[85px] z-40 h-[calc(100vh-85px)] overflow-y-auto bg-[#F8FAFC] shadow-[0_-20px_50px_rgba(0,0,0,0.05)] border-t border-slate-200 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <section className="py-20 min-h-[calc(100vh-85px)] flex flex-col justify-center relative overflow-hidden">
            <div className="absolute inset-0 -z-10">
                  ...
                  <div className="rounded-3xl bg-white/70 backdrop-blur-xl border border-white shadow-2xl shadow-[#00C896]/10 px-6 py-10 sm:px-10 sm:py-12 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center">
                      ...
                      <div className="mt-7 flex flex-col sm:flex-row gap-3 w-full">
                        <a href="https://shrikeshshettyportfolio.vercel.app/" target="_blank" rel="noreferrer" className="inline-flex flex-1 items-center justify-center px-6 py-3.5 rounded-2xl bg-[#0F172A] text-white font-black hover:bg-[#10B981] hover:-translate-y-0.5 active:scale-[0.99] transition-all">
                          View Portfolio
                        </a>
                        <a href="mailto:shrikesh123shetty@gmail.com" className="inline-flex flex-1 items-center justify-center px-6 py-3.5 rounded-2xl border border-[#0F172A]/10 bg-white text-[#0F172A] font-black hover:border-[#10B981] hover:text-[#10B981] hover:-translate-y-0.5 active:scale-[0.99] transition-all">
                          Email
                        </a>
                      </div>
                    </div>
        ...
        {/* 6. PROJECTS AND CERTIFICATE SECTION */}
        <div className="sticky top-[85px] z-50 h-[calc(100vh-85px)] overflow-y-auto bg-white shadow-[0_-20px_50px_rgba(0,0,0,0.05)] border-t border-slate-100 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <div className="min-h-[calc(100vh-85px)] flex flex-col">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {featuredProjects.map((p) => (
                    <Link key={p.id} href={`/shridevfreelance/projectShowcase/${p.id}`} className="block bg-white/80 backdrop-blur-sm border border-[#D1FAE5] rounded-2xl p-6 hover:border-[#10B981] hover:shadow-lg hover:shadow-[#10B981]/10 transition-all">
                ...
                <div className="mt-10 flex justify-center">
                  <Link href="/projects" className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-[#0F172A] text-white font-bold hover:bg-[#10B981] transition-colors">
                    View More
                  </Link>
                </div>
              </div>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div className="rounded-3xl bg-gradient-to-r from-[#0F766E] to-[#10B981] p-8 sm:p-10 text-white overflow-hidden relative">
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    ...
                    <Link href="/certificate-verification" className="inline-flex items-center justify-center px-8 py-4 rounded-2xl bg-white text-[#0F172A] font-black hover:bg-[#D1FAE5] transition-colors">
                      Verify Certificate
                    </Link>
                  </div>
                </div>
