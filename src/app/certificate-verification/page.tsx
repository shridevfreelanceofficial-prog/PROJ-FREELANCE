...
export default function CertificateVerificationPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'radial-gradient(circle at 25% 25%, white 1px, transparent 1px)', backgroundSize: '50px 50px' }}></div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/80 text-lg">
              Verify the authenticity of your ShriDev Freelance certificate
            </p>
          </div>
                ...
                <div className="bg-gradient-to-br from-[#F0FDF4] to-[#D1FAE5] rounded-2xl p-6 space-y-4">
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-[#10B981]/20">
                    ...
                    <span className="font-semibold text-[#111827]">
                      {result.start_date && new Date(result.start_date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })} - 
                      {result.end_date && new Date(result.end_date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-[#10B981]/20">
