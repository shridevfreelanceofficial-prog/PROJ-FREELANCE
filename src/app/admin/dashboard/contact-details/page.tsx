  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-[#111827]">Contact Details</h2>
          <p className="text-[#6B7280]">Messages submitted from the Contact Us page</p>
        </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <p className="font-medium text-[#111827]">Submissions</p>
        ...
        <CardBody className="p-0">
          {items.length === 0 ? (
            <div className="text-center py-12">
              <h3 className="text-lg font-medium text-[#111827] mb-2">No submissions yet</h3>
              <p className="text-[#6B7280]">New messages will appear here.</p>
            </div>
          ) : (
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      {!s.is_read ? (
                        <Button
                          ...
                          size="sm"
                          onClick={async () => {
                            await fetch(`/api/admin/contact-submissions/${s.id}/read`, { method: 'PATCH' });
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          if (!ok) return;
                          const res = await fetch(`/api/admin/contact-submissions/${s.id}`, { method: 'DELETE' });
